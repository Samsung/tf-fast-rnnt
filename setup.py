...
package_name = "tf_fast_rnnt"

#with open("tf_fast_rnnt/python/tf_fast_rnnt/__init__.py", "a") as f:
...
setuptools.setup(
    ...
    author="Hyunsik Kim",
    author_email="hyunsik777.kim@samsung.com",
    package_dir={
        package_name: "tf_fast_rnnt/python/tf_fast_rnnt",
    },
    packages=[package_name],
    url="https://github.com/Samsung/tf-fast-rnnt",
    description="Fast and memory-efficient RNN-T loss.",
    long_description=read_long_description(),
    long_description_content_type="text/markdown",
    install_requires=get_requirements(),
    ext_modules=[cmake_extension("_tf_fast_rnnt")],
